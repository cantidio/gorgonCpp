 ...
 */
#ifndef _GORGON_SOUND_EXCEPTION_
#define _GORGON_SOUND_EXCEPTION_
#include "../core/gorgon_exception.hpp"

namespace Gorgon{
namespace Audio
{
	#define newSoundException(message) SoundException(message,__FILE__,__FUNCTION__,__LINE__)
	/**
	 * Classe que representa as excessões dos sons
	 *
	 ...
	 * @ingroup	Audio
	 */
	class SoundException : public Core::Exception
	{
		public:
			/**
