 ...
 */
#ifndef _GORGON_GRAPHIC_EXCEPTION_
#define _GORGON_GRAPHIC_EXCEPTION_
...
{
	/**
	 * Class that represents graphics exceptions
	 *
...
#define raiseGraphicException(pMessage) throw Gorgon::Graphic::Exception(pMessage,__FILE__,__FUNCTION__,__LINE__)
#define raiseGraphicExceptionE(pMessage,pException) throw Gorgon::Graphic::Exception(pException,pMessage,__FILE__,__FUNCTION__,__LINE__)
