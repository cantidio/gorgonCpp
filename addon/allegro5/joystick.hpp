...
{
	/**
	 * Classe que representa um joystick allegro5
	 *
	 * @author	Cantidio Oliveira Fontes
	 * @since	04/05/2011
	 * @version	04/05/2011
	 */
	class JoystickAllegro : public Input::Joystick
	{
		protected:
		...
		public:
			JoystickAllegro(const int& pIndex);
			/**
			 * Destructor
			 */
			 ...
			 * @return	Stick
			 */
			virtual Stick getStick(const int& pStick) const;
			/**
