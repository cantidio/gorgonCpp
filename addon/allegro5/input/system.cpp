...
namespace Addon
{
	System::System()
	{
		if( !al_init() )
		{
			Core::logWrite("Input::Addon::System::System(): Error, couldn't start Allegro5.");
			raiseInputException("Input::Addon::System::System(): Error, couldn't start Allegro5.");
		}
		if( !al_install_keyboard() )
		{
			Core::logWrite("Input::Addon::System::System(): Error, couldn't install Allegro5's Keyboard.");
			raiseInputException("Input::Addon::System::System(): Error, couldn't install Allegro5's Keyboard.");
		}
		if( !al_install_joystick() )
		{
			Core::logWrite("Input::Addon::System::System(): Error, couldn't install Allegro5's Joystick.");
			raiseInputException("Input::Addon::System::System(): Error, couldn't install Allegro5's Joystick.");
		}
		if( !al_install_mouse() )
		{
			Core::logWrite("Input::Addon::System::System(): Error, couldn't install Allegro5's Mouse.");
			raiseInputException("Input::Addon::System::System(): Error, couldn't install Allegro5's Mouse.");
		}
		Core::logWrite("Input::Addon::System::System(): Allegro5 Input System init Sucessfull.");
	}
